        ...
        <div class="product-single-content">
            <form class="cart add_to_cart_form" action="{{ route('cart.add') }}" id="add-to-cart-form"
                ...
                <div class="btn-grp">
                    ...
                    @else
                        <a href="javascript:"
                        class="btn btn-base text-capitalize addToCart_function_btn"
...
<script type="text/javascript">
    ...
    $('.buyNow_function_btn').on('click', function () {
        buy_now('add-to-cart-form', {{($guestCheckout==1 || Auth::guard('customer')->check()?'true':'false')}}, '{{route('shop-cart')}}');
    });
</script>
